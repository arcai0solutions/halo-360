            ...
            <div className="container px-4 md:px-6 mx-auto relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 mb-20">
                    ...
                    <div className="flex flex-col justify-between">
                        <div className="mb-16">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                {/* Mobile Image */}
                                <div className="block lg:hidden w-24 h-24 pointer-events-none opacity-80 mix-blend-screen transform translate-y-2 relative">
                                     <Image
                                        src="/footer.webp"
                                        alt="Abstract Footer Graphic"
                                        fill
                                        className="object-contain"
                                        sizes="(max-width: 768px) 96px, 1px"
                                     />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4 pt-4">
                                ...
                                <div className="flex gap-4">
                                    {/* Social Icons */}
                                    <a href="https://www.instagram.com/halo.digitalmedia?igsh=YnNidjhkOHdyM2dl" aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                    ...
                    <div className="relative">
                        ...
                        <div className="hidden lg:block absolute top-[80%] left-0 transform -translate-y-1/2 -translate-x-[10%] w-[80%] -z-10 pointer-events-none opacity-80 mix-blend-screen">
                            <Image
                                src="/footer.webp"
                                alt="Abstract Footer Graphic"
                                width={0}
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
                    <p className="flex items-center gap-2">All Rights Reserved. Designed by <a href="https://www.arcai.agency" target="_blank" rel="noopener noreferrer"><Image src="/arc logo.png" alt="ARC AI" width={0} height={0} sizes="100px" className="h-10 w-auto" /></a></p>
